...
<body>
	...
	<div class="x-body">
		<form class="layui-form" method="post" action="${pp}/admin/class/add"
			...
			<div class="layui-form-item classType">
				...
				<div class="layui-input-block">
					<input type="radio" name="a.classType" title="本科课程" value="1"
						checked> <input type="radio" name="a.classType"
						title="专科课程" value="2">
				</div>
			</div>
		...
		layui
				.use(
						...
						function() {
							...
							var input = '<input type="hidden" name="a.isEb" value="'+isEb+'" />';
