	...
	<div class="x-body">
		<div class="layui-row">
			<form class="layui-form layui-col-md12 x-so" method="post">
				<input type="text" name="a.className" placeholder="请输入关键字"
	...
	<script>
		layui.use([ 'layer', 'form', 'element', 'table' ], function() {
			...
			table.on('tool(test)', function(obj) {
				...
				var tr = obj.tr;
				if (layEvent === 'view') {
					var p1 = path + '/admin/class/view.ftl?id=' + data.id;
					x_admin_show('课程详情', p1);
				} else if (layEvent === 'del') {
					layer.confirm('确定删除？', function() {
						$.get(path + "/admin/class/del?id=" + data.id,
								function(r) {
									layer.msg('删除成功');
									tr.remove();
								});
					...
					var p1 = path + '/admin/class/resource/list.ftl?id='
							+ data.id;
...
<img  src="{{fileServer}}/{{d.img}}" width=50  height=50 />
</script>
