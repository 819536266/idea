	...
	<div class="x-body">
		<div class="layui-row">
			<form class="layui-form layui-col-md12 x-so" method="post">
				<input type="text" name="a.ebName" placeholder="请输入关键字"
		...
		<button class="layui-btn"
			onclick="x_admin_show('添加行业', '${pp}/admin/majors/add2.jsp')">
			<i class="layui-icon"></i>添加行业
		</button>
		...
		layui
				.use(
						...
						function() {
							...
							var name = "";
							var url = path + "/admin/majors/list";
							//表格执行渲染
