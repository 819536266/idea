...
<body>
	...
	<div class="x-body">
		<form class="layui-form" method="post"
			...
			<div class="layui-form-item">
				<label class="layui-form-label"> <span class="x-red">*</span>角色：
				</label>
				<div class="layui-input-block">
					<input type="radio" class="r1" name="a.ebType" title="本科教育"
						value="1"> <input type="radio" class="r1" name="a.ebType"
						title="专科教育" value="2">
				</div>
			</div>
			<div class="layui-form-item">
	...
	<script>
		layui.use([ 'form', 'layer', 'layedit' ], function() {
			...
			$.get('${pp}/admin/majors/view/' + key, function(r) {
				...
				$('#preview').append(img);
				var index = parseInt(r.ebType) - 1;
				$('.r1').eq(index).attr('checked', 'checked');
				form.render();
			});
