...
<body>
	...
	<div class="x-body">
		<form class="layui-form" method="post"
			...
			<input type="hidden" name="a.problemType" value="1">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="radio" name="a.right" title="A" value="A"
						checked="checked"> <input type="radio" name="a.right"
						title="B" value="B"> <input type="radio" name="a.right"
						title="C" value="C"> <input type="radio" name="a.right"
						title="D" value="D">
				</div>
			</div>
