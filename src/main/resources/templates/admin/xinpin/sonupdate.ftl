...
<div class="x-body">
    <form class="layui-form" method="post" action="${request.contextPath}/home/update"
        ...
        <#if (homeone.hmOneName?? && homeone.hmOneName!="")>
            <input type="hidden" name="hmOneName" value="${homeone.hmOneName}"/>
        </#if>
        ...
        <#if (homeone.hmUrl?? && homeone.hmUrl!="")>
            ...
            <div class="layui-input-inline">
            <input type="text" id="username" name="hmUrl" required="" value="${homeone.hmUrl}"
            lay-verify="required" autocomplete="off" class="layui-input">
            </div>
            <div class="layui-form-mid layui-word-aux">
        ...
        <#if (homeone.hmOneImage?? && homeone.hmOneImage!="")>
            ...
            <div id="preview"><img src="${request.contextPath}/${homeone.hmOneImage}"/>
        <input type="hidden" value="${homeone.hmOneImage}" name="hmOneImage"/>
            </div>
            </div>
            <div class="layui-form-mid layui-word-aux">
