...
<#--<div class="layui-row">
    ...
    <#--<button class="layui-btn"
            onclick="x_admin_show('添加', '${request.contextPath}/admin/home/zhaopin/add');">
...
<script>
    layui.use([ 'layer', 'form', 'element', 'table' ], function() {
        ...
        var url = path + "/home/list/zhaopin";
        //表格执行渲染
        ...
        table.on('tool(test)', function(obj) {
            ...
            if (layEvent === 'view') {
                ...
                var p1 = path + '/admin/home/zhaopin/update/' + data.hmId;
                ...
                var p1 = path + '/admin/home/zhaopin/son/' + data.hmId + "?homename=" + data.hmOneName;
                x_admin_show("子分类", p1);
            }
        });
    });
